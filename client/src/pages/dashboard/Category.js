...
const Category = () => {
    const [isAddNewCatOpen, setIsAddNewCatOpen] = useState(true);
    ...
    return (
        ...
        <div>
            <header className="mb-4 flex items-center justify-between">
                ...
                <button onClick={()=>setIsAddNewCatOpen(true)} className="btn-primary">Add New Category </button>
            </header>
            <div>
        ...
        <AddCategory isOpen={isAddNewCatOpen} closeModal={()=>setIsAddNewCatOpen(false)} />
        </>
    );
};
